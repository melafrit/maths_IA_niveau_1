...
(function () {
  ...
  // Composants Phases P5.1, P5.2, P5.3 et P5.4
  const { BanqueBrowser, BanqueEditor, BanqueGenerator, BanqueSearch } = window;
  ...
  function BanqueContent() {
    ...
    const tabs = [
      ...
      { id: 'search', label: '🔎 Recherche avancée', component: BanqueSearch, enabled: true },
